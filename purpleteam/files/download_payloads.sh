curl -o payloads/AdFind.zip https://www.joeware.net/downloads/files/AdFind.zip
...
curl -o payloads/NetSess.zip https://www.joeware.net/downloads/files/NetSess.zip
...
# unzip wizard_spider binaries
unzip -o -P "malware" data/adversary-emulation-plans/wizard_spider/Resources/Binaries/binaries.zip
mv -f binaries/* payloads
rmdir binaries

# unzip sandworm binaries
unzip -o -P "malware" data/adversary-emulation-plans/sandworm/Resources/browser-creds/lazagne.exe.zip
mv lazagne.exe payloads/dumpWebBrowserCreds.exe

# unzip oil_rig binaries
unzip -o -P "malware" data/adversary-emulation-plans/oilrig/Resources/Binaries/binaries.zip
mv -f binaries/* payloads
rmdir binaries
